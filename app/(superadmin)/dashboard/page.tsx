...
import { Users, Building2, Package, TrendingUp, DollarSign, AlertTriangle, CheckCircle, Clock, Shield } from "lucide-react"
...
export default function DashboardPage() {
  ...
  if (!user || !["superadmin", "admin", "finance", "vendor"].includes(user.role)) {
    return (
