      ...
      <main className="md:ml-64 pt-16 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">Kelola proses verifikasi mitra baru.</p>
          </div>
          ...
          <div className="bg-white border border-gray-200 shadow-sm rounded-lg p-6 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Halaman Verifikasi Mitra</h3>
            <p className="text-gray-600">Konten untuk verifikasi mitra akan segera hadir di sini.</p>
          </div>
        </div>
      </main>
    </div>
